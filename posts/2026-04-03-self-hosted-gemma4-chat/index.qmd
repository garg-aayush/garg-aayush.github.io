...
- Download `gemma-4-26B-A4B-it-UD-Q4_K_XL.gguf` from the [Unsloth HuggingFace repo](https://huggingface.co/unsloth/gemma-4-26B-A4B-it-GGUF) to a folder on your server. If you also want vision/image support, download `mmproj-BF16.gguf` from the same repo. I keep mine in `~/MODELS/unsloth/gemma-4-26B-A4B-it-GGUF/`
