...
> I have not explored these extensions myself. For actual predictions we anyway rely on ML-based forecasting models, and for the pre-processing role the Kalman filter plays in my workflow, the linear version plus a good transform (like the log-transform in Example 2) has been enough.
...
Both of these usually sit buried inside library internals. They are worth understanding and having within reach.
