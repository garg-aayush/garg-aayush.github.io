...
This post builds the filter and the smoother from first principles and then applies them to two classic datasets: [decomposing the Mauna Loa $\text{CO}_2$ series into trend and seasonality](#example-co2-decomposition) and [reconstructing artificially deleted chunks of the AirPassengers series](#example-airpassengers-gaps).
