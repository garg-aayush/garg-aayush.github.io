...
Most of us are aware of these three Claude Code commands but more often or not, maybe out of habit, we don't use them often enough and end up hitting the session limit.

- **`/context`** — it provides a great visualization of your current conversation context usage as a colored grid. **I prefere to use it often to understand how much of the context window is consumed, loaded skills, mcps, tools and correspodning tokens used.**
...
The below tools are not AI-specific tools but makes my terminal experience much better.
