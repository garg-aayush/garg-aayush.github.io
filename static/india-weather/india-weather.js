...
(function () {
  ...
  // (which targets the literal pk.eyJ1IjoiZ2FyZy1hYXl1c2giLCJhIjoiY21vaXd2NG5uMDZzZTJvczF2MjA4bzNlYSJ9.4RKyJCG48z7djkm9kWkBBQ) only rewrites RAW_TOKEN below.
  const TOKEN_PLACEHOLDER = '__' + 'MAPBOX_TOKEN' + '__';
  const RAW_TOKEN = 'pk.eyJ1IjoiZ2FyZy1hYXl1c2giLCJhIjoiY21vaXd2NG5uMDZzZTJvczF2MjA4bzNlYSJ9.4RKyJCG48z7djkm9kWkBBQ';
  const MAPBOX_TOKEN = (() => {
    try {
